...
- CLI helpers: `moltbot-cn onboard`, `moltbot-cn models list`, `moltbot-cn models set <provider/model>`.
...
- CLI: `moltbot-cn onboard --auth-choice openai-api-key`
...
- CLI: `moltbot-cn onboard --auth-choice token` (paste setup-token) or `moltbot-cn models auth paste-token --provider anthropic`
...
- CLI: `moltbot-cn onboard --auth-choice openai-codex` or `codex-cli`
...
- CLI: `moltbot-cn onboard --auth-choice opencode-zen`
...
- CLI: `moltbot-cn onboard --auth-choice gemini-api-key`
...
- Antigravity OAuth is shipped as a bundled plugin (`google-antigravity-auth`, disabled by default).
  - Enable: `moltbot-cn plugins enable google-antigravity-auth`
  - Login: `moltbot-cn models auth login --provider google-antigravity --set-default`
- Gemini CLI OAuth is shipped as a bundled plugin (`google-gemini-cli-auth`, disabled by default).
  - Enable: `moltbot-cn plugins enable google-gemini-cli-auth`
  - Login: `moltbot-cn models auth login --provider google-gemini-cli --set-default`
...
- CLI: `moltbot-cn onboard --auth-choice zai-api-key`
...
- CLI: `moltbot-cn onboard --auth-choice ai-gateway-api-key`
...
- CLI: `moltbot-cn onboard --auth-choice synthetic-api-key`
...
moltbot-cn models set opencode/claude-opus-4-5
