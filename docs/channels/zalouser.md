...
- Install via CLI: `moltbot-cn plugins install @clawdbot/zalouser`
- Or from a source checkout: `moltbot-cn plugins install ./extensions/zalouser`
...
Approve via:
- `moltbot-cn pairing list zalouser`
- `moltbot-cn pairing approve zalouser <code>`
...
- Re-login: `moltbot-cn channels logout --channel zalouser && moltbot-cn channels login --channel zalouser`
