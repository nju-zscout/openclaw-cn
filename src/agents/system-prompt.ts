...
function buildDocsSection(params: { docsPath?: string; isMinimal: boolean; readToolName: string }) {
  ...
  return [
    ...
    "When diagnosing issues, run `moltbot-cn status` yourself when possible; only ask the user if you lack access (e.g., sandboxed).",
    "",
  ];
}
...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "- moltbot-cn gateway start",
    "- moltbot-cn gateway stop",
    "- moltbot-cn gateway restart",
    "If unsure, ask the user to run `moltbot-cn help` (or `moltbot-cn gateway --help`) and paste the output.",
    "",
    ...skillsSection,
    ...memorySection,
