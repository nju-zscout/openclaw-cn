...
import { normalizeMessageProvider, resolveMessageProvider } from "../utils/message-provider.js";
...
export async function agentCommand(
  ...
  if (opts.thinking && !thinkOverride) {
    throw new Error("Invalid thinking level. Use one of: off, minimal, low, medium, high.");
  }
  ...
  try {
    const messageProvider = resolveMessageProvider(opts.messageProvider, opts.provider);
  ...
  const deliveryProvider = normalizeMessageProvider(opts.provider) ?? "whatsapp";
